...
window.AuthUI = {
    ...
    async routeToUniversalDashboard(user) {
        ...
        if (businessType === 'distributor') {
            window.location.href = '../modules/core/dashboard.html';
        } else if (businessType === 'scrap_collection_center') {
            window.location.href = '../modules/admin/scrap-master.html';
        } else if (businessType === 'manufacturer') {
            window.location.href = '../modules/core/dashboard.html';
        } else if (businessType === 'tire_centre') {
            window.location.href = '../modules/tire_centre/pos.html';
        } else if (businessType === 'pharmacy') {
            window.location.href = '../modules/pharmacy/pos.html';
        } else if (businessType === 'hardware') {
            window.location.href = '../modules/hardware/pos.html';
        } else if (businessType === 'garment') {
            window.location.href = '../modules/garment/pos.html';
        } else if (businessType === 'restaurant') {
            window.location.href = '../modules/restaurant/orders.html';
        } else {
            window.location.href = '../modules/retail/pos.html';
        }
    }
};
