/**
 * DigiBiz PWA bootstrap: manifest + install meta + service worker (all pages).
 * Safe to include on every HTML; skips duplicates.
 */
(function () {
    ...
    window.addEventListener('load', function () {
        navigator.serviceWorker.register('/sw.js?v=111').catch(function () {});
    });
})();
